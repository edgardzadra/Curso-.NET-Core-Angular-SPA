...
export class UserService {
    ...
    getUsers(page?: number, itemsPerPage?: number, userParams?: any, likesParam?: string) {
        ...
        return this.authHttp.get(this.baseUrl + 'user' + queryString).map((response: Response) => {
    ...
    sendLike(id: number, recipientId: number) {
        return this.authHttp.post(this.baseUrl + 'user/' + id + '/like/' + recipientId, {}).catch(this.handleError);
    }
